...
// None indicates that requests are unauthenticated.
...
// FromContextValue extracts caller identity from a value in the incoming request context from the huma context.
//
